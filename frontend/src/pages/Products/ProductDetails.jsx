...
const ProductDetails = () => {
  ...
  return <>
    ...
    {isLoading ? (<Loader />) : error ? (<Message variant='danger'>{error?.data?.message || error.
    message}</Message>) : (
        <>
            <div className="flex flex-wrap relative iyems-between mt-[2rem] ml-[10rem]">
                <div>
                    <img 
                    src={product.image} 
                    alt={product.name} 
                ...
                <div className="flex flex-col justify-between">
                    ...
                    <div className="flex items-center justify-between w-[20rem]">
                        ...
                        <div className='two'>
                            ...
                            <h1 className="flex items-center mb-6">
                                <FaShoppingCart className='mr-2 text-white' /> Quanity: {product.quantity}
                            </h1>
                ...
                <div className="mt-[5rem] container flex flex-wrap items-start
                justify-between ml-[10rem]">
