...
import { setCategories, setProducts, setChecked } from '../redux/feautures/shop/shopSlice'
...
const Shop = () => {
    ...
    const { categories, products, checked, radio } = useSelector((state) => state.
        shop)
    ...
    useEffect(() => {
        if (!checked.length || !radio.length) {
            if (!filteredProductsQuery.isLoading) {
                //Products will be filtered based on both checked categories and price filter.
