...
const Navigation = () => {
    ...
    return <div style={{ zIndex: 999 }} className={`${showSidebar ? "hidden" : 'flex'} xl:flex lg:flex md:hidden
    sm:hidden flex-col justify-between p-4 text-white bg-black hover:w-[15%] h-[100vh] fixed`} id="navigation-container">
        ...
        <div className="relative">
            ...
            {!userInfo && (
                ...
                hover:translate-x-2'>
                        <AiOutlineLogin className="mr-2 mt-[3rem] h-[25px] w-[25px]" size={26} />
                        <span className="hidden nav-item-name mt-[3rem]">
                            Login
                        </span>{" "}
                    </Link>
                ...
                hover:translate-x-2'>
                        <AiOutlineUserAdd className="mr-2 mt-[3rem] h-[25px] w-[25px]" size={26} />
                        <span className="hidden nav-item-name mt-[3rem]">
                            Register
                        </span>{" "}
                    </Link>
